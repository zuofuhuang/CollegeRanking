...
----------------------------------| --------------------------------------------------------|--------------------------------------------------
Size of school (UGDS)             | number of undergraduate degree-seeking students         | Users can select an acceptable range of undergraduate student size between 0-4000 (for LACs) or 0-60000 (for Us).
...
A college's region (REGION)       | region-wise (e.g. Minnesota is in the Plains region)    | This is a decisive multi-checkbox. Users can filter off regions where they don't want to attend college.
