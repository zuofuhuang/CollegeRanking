...
```{R eval = FALSE}
iframe(width="450", height="400", scrolling="no", frameborder="no",  url_link="https://zuofuhuang.shinyapps.io/collegeranking/")
```

## In case you are curious

If you are curious about the code (which is somehow complicated), here it is! Email Zuofu for more details about the code.
